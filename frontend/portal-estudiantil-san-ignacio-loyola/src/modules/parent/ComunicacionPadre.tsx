...
const mockMessages: Message[] = [
  {
    ...
    subject: 'Recordatorio de Matrícula',
    body: 'Estimada Sra. Rodríguez, le recordamos que el plazo para la matrícula de su hijo(a) Sofía finaliza el 30 de noviembre.',
    date: '2025-11-05',
    read: false,
    type: 'received',
  },
  ...
  },
  {
    ...
    recipient: 'María Rodríguez',
    subject: 'Re: Consulta sobre Calificaciones de Sofía',
    body: 'Estimada Sra. Rodríguez, con gusto. Tengo disponibilidad el martes a las 4 PM. ¿Le parece bien?',
    date: '2025-11-04',
    read: true,
    type: 'received',
  },
...
export const ComunicacionPadre = () => {
        ...
        <form onSubmit={handleSendMessage} className="space-y-4">
          <div>
            ...
            >
              ...
              <option value="Prof. Ana García">Prof. Ana García (Matemáticas)</option>
              <option value="Prof. Carlos Pérez">Prof. Carlos Pérez (Historia)</option>
              {/* Add more dynamic recipients based on children's teachers */}
            </select>
          </div>
          <div>
